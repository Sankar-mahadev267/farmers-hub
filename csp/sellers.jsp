...
<body>
    ...
    <br><br><br>
    <div class="sellbuy">
        <form action="form.jsp" method="post" onsubmit="return subval()">
            <p>Post your produce to sell to the buyers</p>
            <input type="text" name="nam" required placeholder="Name">
            <input type="radio" name="sb" value="Seller" required> Sell
            <input type="radio" name="sb" value="Buyyer" required> Buy <br>
            <select name="crop">
            ...
            <input type="number" name="qt" required placeholder="Quantity" style="padding: 5px 0 5px 10px;"> Quintals <br>
            <input type="number" name="ph" required placeholder="Mobile"><br>
            <input type="text" name="adrs" required placeholder="Address"><br>
            <div class="submit"><button class="btn" type="submit">Submit</button></div>
        </form>
    </div>
    ...
    <div class="display">
    <%
        p4 = con.prepareStatement("select * from sellbuy");
        rs4 = p4.executeQuery();
        if(rs4.next()){
            do{%>
                <div class="sb-card">
                    <img src="<%=rs4.getString(3)%>.webp" alt="crop">
                    <p><%=rs4.getString(4)%> Quintals</p>
                    <p><b>Name : </b><%=rs4.getString(1)%></p>
                    <p><b>Ph.no : </b><%=rs4.getString(5)%></p>
                    <p><b>Address : </b><%=rs4.getString(6)%></p>
                    <p><b><%=rs4.getString(2)%></b></p>
                </div>       
            
        <%  }while(rs4.next());
        }
        else{%>
            <h3 align="center" style="padding: 20px;">No sellers or buyers</h3>
      <%}
    ...
    <div class="d5">
        ...
        <div class="contact">
            ...
            <form action="feedback.jsp" method="post">
                ...
                <input type="hidden" name="redirecturl" value="sellers.jsp">
